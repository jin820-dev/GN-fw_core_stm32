...
# ---- path base (do NOT depend on current directory) ----
$userDir = Resolve-Path (Join-Path $PSScriptRoot "..")   # => ...\User

$tmpDir  = Join-Path $userDir "_tmp_ssd1306"
$dstPath = Join-Path $userDir "third_party\afiskon_ssd1306"
